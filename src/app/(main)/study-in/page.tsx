...
const StudyInPage = () => {
 ...
 viewport={{ once: true }}
 whileHover={{ y: -10 }}
 className="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-100 transition-all duration-300 hover:shadow-xl flex flex-col h-full"
>
 ...
 <div className="p-6 flex flex-col h-full">
   ...
   <div className="mt-6 pt-4 border-t border-gray-100">
     <button className="w-full bg-[#327fc7] hover:bg-[#2a6cb3] text-white font-medium py-3 px-4 rounded-lg transition-colors flex items-center justify-center">
